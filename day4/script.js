...
arr3 = arr1.push(...arr2); // arr3 = length of arr1 = 6 (type of arr3 is converted to number)
                           // && arr1 = [1, 2, 3, 5, 6, 7] 
document.writeln("<hr><h2>After arr3 = arr1.push(...arr2)</h2>")
document.writeln(`<h3>
...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////// 5 ///////////////////////////////////////////
document.writeln("<hr><h1>Lab 5: difference between splice() and slice()</h1>");
arr1 = [1, 2, 3, 4];
...
document.writeln("<h2>After arr2 = arr1.splice(1, 2)</h2>");
...
document.writeln("<h2>After arr2 = arr1.splice(1, 0, 2, 3);<br>arr2 = arr1.slice(1, 2)</h2>");
document.writeln(`<h3>arr1 = ${arr1}<br>arr2 = ${arr2}</h3>`);